...
ob_start();
$API_KEY = '2105970480:AAFBjhCuGW_P_JrtxH9s0ELRGeKbDdKj3uc'; #توكنك
...
- في بوت الزخرفة الشامل 🇺🇸🍟✈️

- يمكنك الزخرفه اسمك باللغه الانكليزيه 🇺🇸✈️
...
- وايضا زخرفهاسمك باللغه العربيه 🇺🇸🌨️

- و صنع بايو قناة تليجرام 🌨️🌨️
...
[['text'=>'- بايـوأنسـتا . 🌹🌹','callback_data'=>'mikbio'],['text'=>'- بايـو قناة تـلي . 🌺🌨️','callback_data'=>'mikbioch']],
